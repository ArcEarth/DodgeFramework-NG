# DodgeFramework-NG
SKSE plugin to trigger dodge animation.
Compatibile with SE/AE/VR.

This project is forked from :
- https://github.com/ersh1/DodgeFramework
- https://gitlab.com/colorglass/commonlibsse-sample-plugin

The following steps is majorly focused on building the .dll SKSE plugin
The Paprus scripts should be compiled and UI translation file should be copied into distribution seperately.
...
```commandline
git clone https://github.com/ArcEarth/DodgeFramework-NG.git
```

This will create a directory called `DodgeFramework-NG.git` with a clone of this project.
